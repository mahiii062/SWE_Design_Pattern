 ...
 * public void setStreamingService(String s) { System.out.println("Service: " +
 * s); }
 * }
 * 
 * class Projector {
...
class StreamingPlayer {
    ...
    public void setStreamingService(String s) {
...
class Projector {
    ...
    public void wideScreenMode() {
        System.out.println("Widescreen mode");
    }

    public void setInput(StreamingPlayer p) {
...
class TheaterLights {
    ...
    public void dim(int lvl) {
        System.out.println("Dimmed to " + lvl + "%");
    }
...
// Facade class — knows how to talk to all the subsystem classes
class Facade {
    ...
    // The Facade constructor accepts all the subsystem objects.
    ...
    // The Facade provides a simple method for the client to use.
    ...
    // The Facade also provides a method to stop the movie and shut down the
    // theater.
...
public class DpFacade {
    public static void main(String[] args) {
        // Client code interacts with the Facade, not the subsystem classes.
        Amplifier amp = new Amplifier();
        StreamingPlayer player = new StreamingPlayer();
        Projector projector = new Projector();
        TheaterLights lights = new TheaterLights();

        // The client creates the Facade and passes in the subsystem objects.
